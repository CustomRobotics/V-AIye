...
HD_PWD='C:/Users/softw/source/repos/CustomRobotics/V-AIye/KV260/CR_KV260/CR_KV260.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cr_kv260_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cr_kv260_bd_wrapper.tcl -notrace
