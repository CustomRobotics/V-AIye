...
HD_PWD='C:/Users/softw/source/repos/CustomRobotics/V-AIye/KV260/CR_KV260/CR_KV260.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cr_kv260_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cr_kv260_bd_wrapper.tcl
