...
//Date        : Thu Mar 31 23:15:45 2022
//Host        : ZOMBIE-PC running 64-bit major release  (build 9200)
//Command     : generate_target cr_kv260_bd.bd
//Design      : cr_kv260_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "cr_kv260_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cr_kv260_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "cr_kv260_bd.hwdef" *) 
module cr_kv260_bd
   ();
  ...
  cr_kv260_bd_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
